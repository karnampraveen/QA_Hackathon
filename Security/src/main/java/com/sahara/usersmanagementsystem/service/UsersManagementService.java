...
//            ourUser.setAccountBalance(registrationRequest.getCity());
            ourUser.setRole("USER");
            ourUser.setAccountBalance(0L);
    ...
    public ReqRes login(ReqRes loginRequest){
        ...
        try {
            ...
            var user = usersRepo.findByName(loginRequest.getName()).orElseThrow();
    ...
    public ReqRes refreshToken(ReqRes refreshTokenReqiest){
        ...
        try{
            ...
            OurUsers users = usersRepo.findByName(ourEmail).orElseThrow();
    ...
    public ReqRes getBalance(String name) {
        ReqRes reqRes = new ReqRes();
        try {
            OurUsers usersById = usersRepo.findByName(name).orElseThrow(() -> new RuntimeException("User Not found"));
            reqRes.setOurUsers(usersById);
            reqRes.setStatusCode(200);
            reqRes.setMessage("Users with name '" + name + "' found successfully");
        } catch (Exception e) {
            reqRes.setStatusCode(500);
            reqRes.setMessage("Error occurred: " + e.getMessage());
        }
    ...
    public Long getBalance1(String name) {
        ReqRes reqRes = new ReqRes();
            OurUsers usersByName = usersRepo.findByName(name).get();
        System.out.println("got balance for name:" + usersByName.getAccountBalance());
        return usersByName.getAccountBalance();
    }
...
//                existingUser.setEmail(updatedUser.getEmail());
    ...
    public ReqRes getMyInfo(String name){
        ReqRes reqRes = new ReqRes();
        try {
            Optional<OurUsers> userOptional = usersRepo.findByName(name);
            if (userOptional.isPresent()) {
